...
(function () {
  ...
  /* ---- Icon set ---- */
  const ICONS = {
    clump:   '<path d="M4 10a8 8 0 0 1 16 0v1a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-1Z"/><circle cx="12" cy="9" r="1.6"/><path d="M12 13v7"/><path d="M9 20h6"/>',
    dust:    '<path d="M3 8h11a2.5 2.5 0 1 0-2-4"/><path d="M3 12h15a2.5 2.5 0 1 1-2 4"/><path d="M3 16h9"/>',
    absorb:  '<path d="M12 3s6 6 6 11a6 6 0 1 1-12 0c0-5 6-11 6-11Z"/>',
    odor:    '<path d="M9 3c-1.6 3-2.4 5-2.4 7.5a5.4 5.4 0 0 0 10.8 0c0-2.5-.8-4.5-2.4-7.5"/><path d="M9.5 14.5c.5 1.3 1.4 2 2.5 2s2-.7 2.5-2"/><path d="M4 4l16 16"/>',
